...
post11 = Post.create!(title: "Pick up medication at the vet", content: "Can someone pick up medication for my cat at the vet in Highgate? It's paid for but I forgot to take it with me when I was there. Thanks!", user: bobby, completed: true)
post12 = Post.create!(title: "Moving dresser", content: "Just need someone to quickly help out moving a dresser, it'll be very quick but I can't do it alone. Thanks!", user: bobby, completed: true)
post13 = Post.create!(title: "Teach me to mend sheets", content: "Hi, my sheets are lightly torn but in otherwise good condition. I'd like to mend them but have never done it before, can you show me how to sew them back together?", user: fred, completed: true)
post14 = Post.create!(title: "Help with admin", content: "Hi, my eyes aren't what they used to be which makes admin a bit of a challenge - can someone please help me out with it? SHouldn't take more than 30 minutes.", user: fred, completed: true)
...
post16 = Post.create!(title: "Lift to Richmond", content: "If I'm on your way to Richmond and you have a bit of space in your car boot (I have a few small but heavy things to bring there), I would really appreciate a lift!", user: emma, completed: true)
post17 = Post.create!(title: "Gardening", content: "Hi! Planning on planting various types of flowers and shrubs in my garden, never done it before. Youtube tutorials are nice but would love to learn from a live person as well! ", user: emma, completed: true)
...
Review.create!(content: "Nice and friendly guy, but he scratched my hardwood floor while moving my dresser.", rating: 3, post_id: 12, user_id: bobby.id, bid_id: 14)
